...
def QueryMaker(prompt_usuario, client, dbschema):
    ...
    system_template = """
        # Rol:
            ...
            Tu tarea principal es responder a las preguntas de los usuarios proporcionando scripts SQL. 
            Como último paso en la elaboración de tus respuestas, siempre evalúas la coherencia y objetividad de las mismas.
        
        #Este es el esquema: 
            {dbschema}

        #Tarea:
            Creas consultas SQL los cuales poseen los siguientes criterios de aceptacion:
